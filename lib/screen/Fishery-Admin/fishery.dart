    ...
    final appState = Provider.of<AppState>(context);
                ...
                return Scaffold(
                  ...
                  body: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        SizedBox(height:150),
                        Container(height:50,width:MediaQuery.of(context).size.width*0.70,
        ...
        hintText: "paste your link here"),
           ...
           SizedBox(height:10),
                ...
                Column(
                  children: [
                    IconButton(
                      tooltip: "paste",
                      onPressed: () async{
                        appState.youtubeLinkController.text=  await FlutterClipboard.paste();
                            String foo = getIdFromUrl(appState.youtubeLinkController.text);
              if(foo==null && appState.youtubeLinkController.text.length != 0){
                  setState(() {
                    error=true;
                  });
              }else{
                ...
                Column(
                  children: [
                    IconButton(
              tooltip: "reset",
              onPressed: () {appState.youtubeLinkController.clear();},
            ...
            SizedBox(height:45),
               error? Text("Link Incorrect",style:Theme.of(context).textTheme.caption.copyWith(color: Colors.red)):Container(), SizedBox(height:8.0),
            Container(
              height: 60,
