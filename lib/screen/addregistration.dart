...
class _AddRegistrationDetailState extends State<AddRegistrationDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    return appState.vendorData != null
        ? Homepage()
