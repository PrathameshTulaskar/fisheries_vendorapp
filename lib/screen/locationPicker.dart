import 'dart:async';
import 'package:fisheries_vendorapp/screen/google_web_services/src/places.dart';
...
class PlacePickerScreenState extends State<PlacePickerScreen> {
  ...
  _moveCamera(LatLng latLng, double zoom) async {
    googleMapController.animateCamera(CameraUpdate.newCameraPosition(
        ...
        print("move camera location change with LAT LNG : ${latLng.latitude} :: ${latLng.longitude}");
  }
  ...
  Widget build(BuildContext context) {
    ...
    _setSelectedAddress(LatLng latLng, String address) async {
      ...
      print("set location with LAT LNg : ${latLng.latitude} :: ${latLng.longitude} ");
      appState.supermarketPositionValue = latLng;
    }
          ...
          Expanded(
            child: Stack(
              ...
              children: <Widget>[
                    ...
                    if (ignoreGeocoding) {
                      ...
                      setState(() {
                       ...
                       final coordinates = new Coordinates(centerCamera.latitude,centerCamera.longitude);
                        ...
                        var featureName = addresses.first.featureName;
                        var addressLine = addresses.first.addressLine;
                        appState.location.text = "$featureName : $addressLine";
                        print("${first.featureName} : ${first.addressLine} test");
                ...
                _mapButtons(appState.location,currentLoc: appState.supermarketPosition),
                Center(
                  child: Container(
